                            ...
                            if (txtCurp.Text.Length == 18)
                            {
                                if (txtNewPassword.Text == txtRepeatPassword.Text)
                                {
                                    if (ckbTerminos.Checked)
                                    {
                                        ...
                                        if (decla.dosomething("INSERT INTO usuario(Nombre, CURP, Direccion, Telefono, Correo, Contra) VALUES (@Nombre,@CURP,@Direccion,@Telefono,@Correo, SHA2(@Contra,512))"))  //Llama al metodo que ejecuta acciones en la base de datos
                                        {
